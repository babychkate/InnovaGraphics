...
namespace InnovaGraphics.Migrations
{
    ...
    [Migration("20250523153854_ShopItemType field in ShopItem entity")]
    partial class ShopItemTypefieldinShopItementity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InnovaGraphics.Models.Profile", b =>
                {
                    b.HasOne("InnovaGraphics.Models.Avatar", "Avatar")
                        .WithOne("Profile")
                        .HasForeignKey("InnovaGraphics.Models.Profile", "AvatarId")
