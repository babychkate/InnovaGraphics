...
const likedMaterials = [
    {
        ...
        isLicked: true,
        image: "/site-icon/site-icon-1.png",
    },
    {
        id: 2,
        ...
        isLicked: true,
        image: "/course/course-2.png",
    },
    {
        id: 3,
        name: 'RGB vs CMYK: What’s the difference?',
        theme: "Комп’ютерні моделі кольорів",
        description: "Lorem ipsum dolor sit amet...",
        isLicked: true,
        image: "/video-texture/video-texture-1.png",
        youtubeId: 'NnP-SRiOc4o?si=7p4QHOGW8VwQAqYB'
    },
];
        ...
        <div className='min-h-[calc(100vh-121px)] bg-[#85A7FA] flex flex-col gap-4 py-8'>
            ...
            <div className='flex flex-col gap-4 px-4'>
                ...
                {likedMaterials.map((material) => (
                    <div key={material.id} className="cursor-pointer group">
                        <div className="relative flex items-start bg-[#C2D3FD] p-4 rounded-4xl shadow-md overflow-hidden transition hover:scale-[1.01]">
                            <Heart
                                className={`absolute top-4 right-4 w-5 h-5 text-red-500`}
                            />
                            <img
                                src={material.image}
                                alt={material.name}
                                className={`rounded-4xl object-cover transition-all 
                                    ${material.youtubeId ? 'w-48 h-32' : 'w-10 h-10'}`}
                            />
